Init <- function(lecture, lecturenumber){
  ...
  # set filepaths
  filepath_base <- "D:/Dokumente/Studium/Master_Marburg/"
  path_data <- paste0(filepath_base, "data/")
  path_fun <- paste0(filepath_base, "msc-phygeo-class-of-2016-JulianGroll/fun/")
  ...
  path_scripts <- paste0(filepath_base, "msc-phygeo-class-of-2016-JulianGroll/",lecture_full,"/", lecture, "-ws-", lecturenumber,"/")
  ...
  saga_path <- "C:\\Program Files (x86)\\SAGA"
